...
export function createInitialToolRegistry():ToolRegistry { return new ToolRegistry([capabilities,selectedDatabase,...schemaAgentTools,...knowledgeAgentTools,...businessKnowledgeAgentTools,...githubAgentTools,...runtimeAgentTools,...sqlAgentTools]); }
