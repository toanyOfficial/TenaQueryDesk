...
type Props = Readonly<{ database: DatabaseOption | null; messages: ReadonlyArray<AnalysisMessage>; question: string; disabled: boolean; submitting: boolean; error: string | null; notice: string | null; onQuestionChange: (value: string) => void; onClear: () => void; onSubmit: () => void }>;

export function AssistantPanel({ database, messages, question, disabled, submitting, error, notice, onQuestionChange, onClear, onSubmit }: Props) {
